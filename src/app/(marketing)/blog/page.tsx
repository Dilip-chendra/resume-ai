      ...
      <main className="flex-1 py-32">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-zinc-400">Everything you need to know to land your dream job in {currentYear}.</p>
          </div>

          {posts.length === 0 ? (
            <div className="bg-zinc-900 border border-white/10 rounded-2xl p-12 text-center max-w-2xl mx-auto">
              ...
              <p className="text-zinc-400">Check back soon for new articles on career advice and resume tips.</p>
            </div>
          ) : (
